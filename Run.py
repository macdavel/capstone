...
# Create network with 3 layers
	...
	net = nl.net.newelm(data_parameters, [10,1], [nl.trans.TanSig(), nl.trans.PureLin()])
	# net = nl.net.newff([[-4, 4],[-4,4]], [70,1], [nl.trans.TanSig(), nl.trans.PureLin()])
	...
	# print "done printing"
	# print train_set_input
	error = net.train( train_set_input, train_set_output, epochs=5000, show=1000, goal=0.0000000000000000000000000015)
...
generate_train_inputDataset(2,14)